...
1.就绪列表     :本列表中的充电宝(未充电完成),谁的电量大，谁就可以充电
2.紧急列表     :本列表中的充电宝(电量==0   ),可以抢占1中的列表
3.充电完成列表 :本列表中的充电宝(已充电完成),排在1,2列表后面充电
...
static Queue_Type ready[MAX_CHANNEL];    //就绪列表
static Queue_Type urgent[MAX_CHANNEL];   //紧急列表
static Queue_Type full[MAX_CHANNEL];     //充电完成列表
/*===================================================
                本地函数
====================================================*/
//初始化
