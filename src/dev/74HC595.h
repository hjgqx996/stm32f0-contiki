...
#define HC595_CLK_H()           GPIO_SetBits(GPIOA,GPIO_Pin_5) 
#define HC595_CLK_L()           GPIO_ResetBits(GPIOA,GPIO_Pin_5)
 
#define HC595_CS_PIN            GPIO_Pin_4 
#define HC595_CS_GPIO           GPIOA 
#define HC595_CS_GPIO_CLK       RCC_APB2Periph_GPIOA 
#define HC595_CS_H()            GPIO_SetBits(GPIOA,GPIO_Pin_4)
#define HC595_CS_L()            GPIO_ResetBits(GPIOA,GPIO_Pin_4) 
 
#define HC595_DATA_PIN          GPIO_Pin_6 
#define HC595_DATA_GPIO         GPIOA 
#define HC595_DATA_GPIO_CLK     RCC_APB2Periph_GPIOA 
#define HC595_DATA_H()          GPIO_SetBits(GPIOA,GPIO_Pin_6) 
